...
# ----------------------------------------------------------------------
fig8 = plt.figure(facecolor='white')
...
# ----------------------------------------------------------------------
fig9 = plt.figure(facecolor='white')
...
# FIGURE 10
# ----------------------------------------------------------------------
fig10 = plt.figure(facecolor='white')
...
# FIGURE 11
# ----------------------------------------------------------------------
fig11 = plt.figure(facecolor='white')
...
# ----------------------------------------------------------------------
fig12 = plt.figure(facecolor='white')
...
prices_y = DataFrame(prices.Electricity.values, index=prices.index.year)
...
# ----------------------------------------------------------------------
fig13 = plt.figure(facecolor='white')
...
def position(prces, resid, num_std, ma_resid, std_resid):
...
num_std = 1.75	
rslt09, pos_m2m09, pos_f09 = position(pr_year.values[2009], res_09[:,0], num_std, ma_res_09, std_res09)	
rslt10, pos_m2m10, pos_f10 = position(pr_year.values[2010], res_10[:,0], num_std, ma_res_10, std_res10)
rslt11, pos_m2m11, pos_f11 = position(pr_year.values[2011], res_11[:,0], num_std, ma_res_11, std_res11)
rslt12, pos_m2m12, pos_f12 = position(pr_year.values[2012], res_12[:,0], num_std, ma_res_12, std_res12)
rslt13, pos_m2m13, pos_f13 = position(pr_year.values[2013], res_13[:,0], num_std, ma_res_13, std_res13)
...
# ----------------------------------------------------------------------
# FIGURE 14 : Final Backtesting results without stop losses
# ----------------------------------------------------------------------
fig14 = plt.figure(facecolor='white')
ax01 = fig14.add_subplot(4,1,1)
ax02 = fig14.add_subplot(4,1,2)
ax03 = fig14.add_subplot(4,1,3)
ax04 = fig14.add_subplot(4,1,4)	

ax01.plot(rslt09.cumsum(), color='black', lw=2, label='ActualP&L09' )
ax01.plot(pos_m2m09, color='red', lw=1, label='M2M_Results09' )
ax01.legend(loc='best')
ax01.set_title('Results 2009')

ax02.plot(rslt10.cumsum(), color='black', lw=2, label='ActualP&L10'  )
ax02.plot(pos_m2m10, color='red', lw=1, label='M2M_Results10')
ax02.legend(loc='best')
ax02.set_title('Results 2010')

ax03.plot(rslt11.cumsum(), color='black', lw=2, label='ActualP&L11' )
ax03.plot(pos_m2m11,  color='red', lw=1, label='M2M_Results11')
ax03.legend(loc='best')
ax03.set_title('Results 2011')

ax04.plot(rslt12.cumsum(), color='black', lw=2, label='ActualP&L12' )
ax04.plot(pos_m2m12,  color='red', lw=1, label='M2M_Results12')
ax04.legend(loc='best')
ax04.set_title('Results 2012')

fig14.text(0.5,0.975,'QS1 - Yearly P&L without Stop-Losses and Profit-Taking levels', horizontalalignment='center',
verticalalignment='top')

# ----------------------------------------------------------------------
# FIGURE 15 : Final Backtesting results with stop losses
# ----------------------------------------------------------------------
fig15 = plt.figure(facecolor='white')
ax01 = fig15.add_subplot(4,1,1)
ax02 = fig15.add_subplot(4,1,2)
ax03 = fig15.add_subplot(4,1,3)
ax04 = fig15.add_subplot(4,1,4)	

ax01.plot(rslt09_s.cumsum(), color='black', lw=2, label='ActualP&L09' )
ax01.plot(pos_m2m09_s, color='red', lw=1, label='M2M_Results09' )
ax01.legend(loc='best')
ax01.set_title('Results 2009')

ax02.plot(rslt10_s.cumsum(), color='black', lw=2, label='ActualP&L10'  )
ax02.plot(pos_m2m10_s, color='red', lw=1, label='M2M_Results10')
ax02.legend(loc='best')
ax02.set_title('Results 2010')

ax03.plot(rslt11_s.cumsum(), color='black', lw=2, label='ActualP&L11' )
ax03.plot(pos_m2m11_s,  color='red', lw=1, label='M2M_Results11')
ax03.legend(loc='best')
ax03.set_title('Results 2011')

ax04.plot(rslt12_s.cumsum(), color='black', lw=2, label='ActualP&L12' )
ax04.plot(pos_m2m12_s,  color='red', lw=1, label='M2M_Results12')
ax04.legend(loc='best')
ax04.set_title('Results 2012')

fig15.text(0.5,0.975,'QS1 - Yearly P&L with Stop-Losses and Profit-Taking levels', horizontalalignment='center',
verticalalignment='top')

# ----------------------------------------------------------------------
# FIGURE 16-17-18-19-20 : Final Backtesting results per year
# ----------------------------------------------------------------------
plt.rc('axes', grid=True)
...
ax01 = fig16.add_axes(rect1, axisbg=axescolor) 
ax01.plot( ma_res_09,'k--', label='MA25_resid' )
ax01.plot( ma_res_09 + num_std*std_res09, 'r--', label='MA25+STD25_resid' )
ax01.plot( ma_res_09 - num_std*std_res09, 'r--', label='MA25-STD25_resid' )
ax01.plot( res_09[:,0], 'ro--', label='Residuals' )
ax01.legend(loc='best')
ax05 = ax01.twinx()
ax05.plot(pr_year.values[2009], 'k-',lw=2, label='DEBY09')
ax05.legend(loc='best')
ax001 =  fig16.add_axes(rect2, axisbg=axescolor, sharex=ax01)
...
ax02.plot( ma_res_10 + num_std*std_res10, 'r--', label='MA25+STD25_resid' )
ax02.plot( ma_res_10 - num_std*std_res10, 'r--', label='MA25-STD25_resid' )
ax02.plot( res_10[:,0], 'ro--', label='Residuals' )
ax02.legend(loc='best')
ax02.set_title('Residuals2010')
ax05 = ax02.twinx()
ax05.plot(pr_year.values[2010], 'k-',lw=2, label='DEBY10')
ax05.legend(loc='best')
...
ax02.plot( ma_res_11 - num_std*std_res11, 'r--', label='MA25-STD25_resid' )
ax02.plot( res_11[:,0], 'ro--', label='Residuals' )
ax02.legend(loc='best')
ax02.set_title('Residuals2011')
ax05 = ax02.twinx()
ax05.plot(pr_year.values[2011], 'k-',lw=2, label='DEBY11')
ax05.legend(loc='best')
...
ax002.axhline(0, color=fillcolor)
# ----------------------------------------------------------------------
fig19 = plt.figure(facecolor='white')
ax02 = fig19.add_axes(rect1, axisbg=axescolor) 
ax02.plot( ma_res_12, 'k--', label='MA25_resid' )
ax02.plot( ma_res_12 + num_std*std_res12, 'r--', label='MA25+STD25_resid' )
ax02.plot( ma_res_12 - num_std*std_res12, 'r--', label='MA25-STD25_resid' )
ax02.plot( res_12[:,0], 'ro--', label='Residuals' )
ax02.legend(loc='best')
ax02.set_title('Residuals2012')
ax05 = ax02.twinx()
ax05.plot(pr_year.values[2012], 'k-',lw=2, label='DEBY12')
ax05.legend(loc='best')
ax002 =  fig19.add_axes(rect2, axisbg=axescolor, sharex=ax02)
...
ax002.axhline(0, color=fillcolor)
# ----------------------------------------------------------------------
fig20 = plt.figure(facecolor='white')
ax02 = fig20.add_axes(rect1, axisbg=axescolor) 
ax02.plot( ma_res_13, 'k--', label='MA25_resid' )
ax02.plot( ma_res_13 + num_std*std_res13, 'r--', label='MA25+STD25_resid' )
ax02.plot( ma_res_13 - num_std*std_res13, 'r--', label='MA25-STD25_resid' )
ax02.plot( res_13[:,0], 'ro--', label='Residuals' )
ax02.legend(loc='best')
ax02.set_title('Residuals2013')
ax05 = ax02.twinx()
ax05.plot(pr_year.values[2013], 'k-',lw=2, label='DEBY13')
ax05.legend(loc='best')
ax002 =  fig20.add_axes(rect2, axisbg=axescolor, sharex=ax02)
...
verticalalignment='top')
fig19.text(0.5,0.975,'QS1 - Yearly P&L without Stop-Losses and Profit-Taking levels', horizontalalignment='center',
verticalalignment='top')
fig20.text(0.5,0.975,'QS1 - Yearly P&L without Stop-Losses and Profit-Taking levels', horizontalalignment='center',
verticalalignment='top')

# ----------------------------------------------------------------------
# FIGURE 21 : Empirical distribution of P&L (acumulated per year)
# ----------------------------------------------------------------------
fig21 = plt.figure(facecolor='white')
results_total = np.append ( np.append(rslt09, rslt10) , np.append(rslt11, rslt12) ) 
resutls_total = np.append (results_total, rslt13)
results_cum = DataFrame(filter((lambda x : x != 0 ), results_total))

# rslt09 = DataFrame(filter((lambda x : x != 0 ), rslt09)
# rslt10 = DataFrame(filter((lambda x : x != 0 ), rslt10)
# rslt11 = DataFrame(filter((lambda x : x != 0 ), rslt11)
# rslt12 = DataFrame(filter((lambda x : x != 0 ), rslt12)

# rslt09.hist(bins=10, alpha = 0.2, color='r')
# rslt10.hist(bins=10, alpha = 0.2, color='b')
# rslt11.hist(bins=10, alpha = 0.2, color='k')
# rslt12.hist(bins=10, alpha = 0.2, color='y')
#results_cum.hist(bins=10, alpha = 0.2, color='g')
# fig21 = pd.hist(results_cum.values, bins=10, alpha = 0.2, color='g', normed=True)
fig19 = results_cum.hist(bins=10, alpha = 0.3, color='g')
# fig19.set_title('Histogram of the P&L from 2009 to 2013')
show()