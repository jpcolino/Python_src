...
ax001.plot(rslt09.cumsum(), color='black', lw=2, label='ActualP&L09' )
ax001.plot(pos_m2m09, color='red', lw=1, label='M2M_Results09' )
...
ax002.plot(rslt10.cumsum(), color='black', lw=2, label='ActualP&L10'  )
ax002.plot(pos_m2m10, color='red', lw=1, label='M2M_Results10')
...
ax002.plot(rslt11.cumsum(), color='black', lw=2, label='ActualP&L11'  )
ax002.plot(pos_m2m11, color='red', lw=1, label='M2M_Results11')
ax002.legend(loc='best')
...
ax002.plot(rslt12.cumsum(), color='black', lw=2, label='ActualP&L12'  )
ax002.plot(pos_m2m12, color='red', lw=1, label='M2M_Results12')
ax002.legend(loc='best')
