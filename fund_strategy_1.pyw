...
ax1.text(0.5, 0.9, '>70 = Buy signal', va='top', transform=ax1.transAxes, fontsize=textsize)
ax1.text(0.5, 0.1, '<30 = Sell signal', transform=ax1.transAxes, fontsize=textsize)
ax1.set_ylim(0, 100)
