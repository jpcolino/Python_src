...
prediction_y = DataFrame(prediction, index = prices.index[data2.Electricity.count()-results3.shape:].year)
...
ax2.plot(residual_ots.ix[2009].values)
ax2.plot(residual_ots.ix[2010].values)
ax2.plot(residual_ots.ix[2011].values)
ax2.plot(residual_ots.ix[2012].values)

ax3 = fig1.add_subplot(3,1,3)
ax3.hist(residual_ots.ix[2009].values,bins=25, alpha = 0.2, color='c', normed=True)
ax3.hist(residual_ots.ix[2010].values,bins=25, alpha = 0.2, color='b', normed=True)
ax3.hist(residual_ots.ix[2011].values,bins=25, alpha = 0.2, color='k', normed=True)
ax3.hist(residual_ots.ix[2012].values,bins=25, alpha = 0.2, color='r', normed=True)
